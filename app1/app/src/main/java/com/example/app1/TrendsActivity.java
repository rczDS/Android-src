...
public class TrendsActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = TrendsActivity.class.getSimpleName();
    // Unique tag required for the intent extra
    public static final String EXTRA_MESSAGE
            = "com.example.app1.extra.MESSAGE";
...
//        mReplyTextView = findViewById(R.id.text_message_reply);
     ...
     */
    public void launchTrendDetailActivity(View view) {
        Log.d(LOG_TAG, "Button clicked!");
        Intent intent = new Intent(this, TrendsDetailActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TEXT_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                String reply = data.getStringExtra(TrendsDetailActivity.EXTRA_REPLY);
